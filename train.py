...
def parse_args():
    ...
    parser.add_argument('--run_times', type=int, default=3, help='example multiple times to eliminate error')
...
def _run_(args, file_name, run_cnt):
    ...
    model = Mcft(args=args, feature_size=feature_size, run_cnt=run_cnt)
...
if __name__ == "__main__":
    ...
    print('example time : %d' % args.run_times)
